(function () {
  ...
  var ResourceRecordType = {
    ...
    'PTR': {'type': 'PTR', 'allowDuplicates': true,
      'rrdataType': ['hostname'], 'name': 'ip_address'},
    'SOA': {'type': 'SOA', 'allowDuplicates': false,
      'rrdataType': ['name_server', 'email', 'serial', 'refresh', 'retry', 'expire', 'cache']},
